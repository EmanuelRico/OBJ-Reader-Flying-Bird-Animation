...
Colibri::Colibri(string obj_file, double Ia) : Object(obj_file){
	
}

void Colibri::set_transf(arma::dmat tr){
    this->transf = tr;
}

arma::dmat Colibri::get_transf(){
    return this->transf;
}

void Colibri::print_Colibri(double Ip, arma::drowvec light_pos){
...
void Colibri::rotate(double *ang, double dang){
