...
Rock::Rock(string obj_file, double Ia) : Object(obj_file){
	
}

void Rock::set_transf(arma::dmat tr){
    this->transf = tr;
}

arma::dmat Rock::get_transf(){
    return this->transf;
}

void Rock::print_Rock(double Ip, arma::drowvec light_pos){
