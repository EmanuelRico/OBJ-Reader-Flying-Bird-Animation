...
Tree::Tree(string obj_file, double Ia) : Object(obj_file){
	
}

void Tree::set_transf(arma::dmat tr){
    this->transf = tr;
}

arma::dmat Tree::get_transf(){
    return this->transf;
}

void Tree::print_Tree(double Ip, arma::drowvec light_pos){
